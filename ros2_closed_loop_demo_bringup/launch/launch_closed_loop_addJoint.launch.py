...
from launch.actions import RegisterEventHandler, ExecuteProcess, TimerAction, IncludeLaunchDescription, DeclareLaunchArgument, EmitEvent, OpaqueFunction, AppendEnvironmentVariable, SetEnvironmentVariable
...
def generate_launch_description():
    ...
    world_name = 'demo_world_addJoint'
    ...
    ros_gz_bridge_pkg = 'ros_gz_bridge'
